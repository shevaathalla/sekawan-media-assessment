        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Add new Driver for the vehicle</h4>
                </div>
                <div class="card-body">
                    <p>
                        You can register new driver to drive the vehicle!
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a class="float-right btn btn-success fw-bold" href="{{ route('driver.index') }}">Back</a>
                        </div>
                        <div class="card-body">
